 ...
 * - High-level GameController depends on this abstraction<br>
 * - Low-level GuiController implements this abstraction<br>
 * - Both depend on the abstraction, not on each other<br>
 * </p>
 * <p>
 * Benefits:<br>
 * - GameController can work with ANY UI implementation<br>
 * - Can test GameController without JavaFX<br>
